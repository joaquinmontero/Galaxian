 ...
 * Añade el conjunto de imagenes al arreglo de imagenes de Perdedor
...
public class Perdedor extends Enemigo {
	public Perdedor(int velocidad,int x, int y, int v) {
		...
		this.image[2] = new ImageIcon(this.getClass().getResource("/sprites/Armado_derecha.png"));
		this.image[3] = new ImageIcon(this.getClass().getResource("/sprites/Armado_izquierda.png"));
}
}
